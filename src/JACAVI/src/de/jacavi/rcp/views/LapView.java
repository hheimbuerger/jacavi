...
public class LapView extends ViewPart implements LapCompletionListener, IPerspectiveListener {
    ...
    public LapView() {
        ...
        ((RaceStatisticsManager) ContextLoader.getBean("statisticsRegistryBean")).addListener(this);
        ...
        public String getColumnText(Object element, int columnIndex) {
            ...
            switch(columnIndex) {
                case 0:
                    ...
                    break;
                case 1:
                    result = formatter.format(new Date(p.getRaceStatistic().getLastLap()));
                    break;
                case 2:
                    result = formatter.format(new Date(p.getRaceStatistic().getBestLap()));
                    break;
                case 3:
