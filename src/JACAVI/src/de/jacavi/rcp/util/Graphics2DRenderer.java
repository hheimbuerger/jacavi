 ...
 * <p>
 * Original source for this unmodified class: http://www-128.ibm.com/developerworks/java/library/j-2dswt/
 * 
...
public class Graphics2DRenderer {
     ...
     */
    public void prepareRendering(Graphics2D graphics) {
    ...
    public Graphics2D getGraphics2D() {
        if(awtImage == null)
            return null;
        return awtImage.createGraphics();
    }
